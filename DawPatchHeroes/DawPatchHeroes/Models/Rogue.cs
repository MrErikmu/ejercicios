...
/// <summary>
/// Subclase de heroe que se especializa en precision
/// </summary>
public class Rogue:Heroe
{
    ...
    {
        Hp -= Config.Config.RogueBaseFailDmg;
        return $"¡Oh no! {Name} got injured during training and loses {Config.Config.RogueBaseFailDmg} health points.";
    }
    ...
    public override void Rest()
    {
        ...
        Hp = Config.Config.RogueBaseMaxHp * Lvl;
    }
